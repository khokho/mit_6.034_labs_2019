...
grandchild_rule = IF( AND("grandparent (?a) (?b)"),
                THEN("grandchild (?b) (?a)") )
...
pprint(forward_chain(family_rules, sibling_test_data, verbose=2))
...
SUGGESTIONS = "Explain how the rules are applied better "
